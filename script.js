    ...
    function renderLaptops(data) {
      ...
      paginatedLaptops.forEach(laptop => {
        ...
        item.innerHTML = `
          ...
          <div class="flex flex-row flex-nowrap justify-between items-end gap-2">
            ...
            <li><strong>Graphics:</strong> ${laptop.graphics}</li>
              ...
              <a href="https://wa.link/laptopmartmultan" target="_blank" class="group text-[#252054] bg-[#fafafa] flex flex-row flex-nowrap items-center gap-2 px-4 py-2 bg-primary rounded-lg hover:bg-blue-600 hover:text-[#fafafa] transition">
